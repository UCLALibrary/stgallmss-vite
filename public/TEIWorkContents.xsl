        ...
        : <i>
          ...
          <DIV
            ...
            <DIV
                                        ...
                                        <xsl:value-of select="$count" />_<xsl:value-of
                ...
                <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <a target="_top"
                                                    href="/stgallmss/viewItem.do?xmlstylesheet=TEITranscription.xsl&amp;count={@n}&amp;ark={tei:locus/@facs}&amp;fileId={$fileId}">
                ...
                <xsl:if
                            ...
                            <a
                                                        ...
                                                        onclick="fetchFile('TEISubWorkBibliography.xsl','{$fileId}','','{@n}');">
                ...
                <xsl:if
                                            ...
                                            <a target="_top" style="border-style:none"
                                                href="/stgallmss/viewItem.do?xmlstylesheet=TEIWorkSubContents.xsl&amp;count={@n}&amp;pageArk={tei:locus/@facs}&amp;fileId={$fileId}">
                                                <img src="/images/icon_content.jpg" width="20"
                                                    height="20" alt="Content" style="" />
                                            </a><xsl:text> </xsl:text>
                                        </xsl:if>
                <a
                                            target="_top" style=""
