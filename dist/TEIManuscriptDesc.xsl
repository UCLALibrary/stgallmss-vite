                ...
                <tr>
                  <td width="33%" class="subnav_off">
                   <!-- href="/stgallmss/viewFile.do?xmlstylesheet=TEIManuscriptContents.xsl&amp;fileId={$fileId}"-->
                    <a
                      href="javascript:void(0)" onclick="performXSLTTransformation('TEIManuscriptContents.xsl');"
                      >Contents</a>
                  </td>
                  <td width="33%" class="subnav_off">
                   <!-- href="/stgallmss/viewFile.do?xmlstylesheet=TEIManuscriptBiblio.xsl&amp;&amp;fileId={$fileId}"-->
                    <a
                      href="javascript:void(0)" onclick="performXSLTTransformation('TEIManuscriptBiblio.xsl');"
                      >Codicological Bibliography</a>
                  </td>
                  <td class="subnav_on">Codicological Description</td>
                </tr>
              </table>
            ...
            <td align="left" valign="top">
              ...
              <DIV class="tan_divider">
                ...
                <p>
                  ...
                  <xsl:for-each
                    select="tei:TEI/tei:text/tei:body/tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:collation">
					   ...
					   <b>Collation: </b><span style="padding:2px;"><xsl:apply-templates/></span>
                ...
                <p>
                  ...
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="tei:TEI/tei:text/tei:body/tei:msDesc/tei:physDesc/tei:additions/tei:p"/>
                </p>
                <p>
                  <b>Date: </b>
                  <xsl:text> </xsl:text>
