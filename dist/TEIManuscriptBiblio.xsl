                ...
                <td>
                    ...
                    <table width="100%" border="0" cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td width="33%" class="subnav_on">Codicological
                                        Bibliography</td>
    ...
    Description</a>
            ...
            <tr>
                <td align="left" valign="top">
                    ...
                    <!-- Contents for left view frame copy paste the DIV tag section to add more content.
                        The page numbers to the right are under span tags-->
                    <xsl:for-each select="tei:TEI/tei:text/tei:body/tei:msDesc/tei:additional/tei:listBibl">
